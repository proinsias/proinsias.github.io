...
If you try to run a Docker container from within PyCharm, and you get something
like:
...
Then you should clear all pycharm helpers from your docker containers and
images:
...
Another useful troubleshooting tip for Docker-related errors is to select
`File > Invalidate Caches...` within PyCharm, and then restart the app.
