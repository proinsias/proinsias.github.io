...
> [this proxy](http://deelay.me) you can simulate unexpected network conditions
> when loading a specific resource.

To use `deelay.me`, change your link to:
deelay.me/<delay in milliseconds>/<original url>. For example:
