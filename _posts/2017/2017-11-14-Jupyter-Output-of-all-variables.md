...
> `print` in front of each, only the last one gets outputted. With this, you get
> them all:
...
> If you want to set this behavior for all instances of Jupyter, simply create a
> file `~/.ipython/profile_default/ipython_config.py` with the lines below.
