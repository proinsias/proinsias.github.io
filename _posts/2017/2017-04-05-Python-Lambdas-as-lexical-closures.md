...
excerpt:
    A function that remembers the values from the enclosing lexical scope even
...
from the enclosing lexical scope even when the program flow is no longer in that
scope. Here's a (fairly academic) example to illustrate the idea:
