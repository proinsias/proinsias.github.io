...
For instance, if we'd like to see the size of the `reservations` table, we can
...
expect, the referenced table needs to be part of the connected database and on
the search path.
