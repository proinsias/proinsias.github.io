...
previous command, you can hit `Ctrl-p`. To move _down_ to the next command in
your shell history, you can hit `Ctrl-n`.
...
`META->` to move to the end and beginning of your shell history, respectively.
