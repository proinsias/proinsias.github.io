...
> time order. Each line of output contains the user name, the tty from which the
> session was conducted, any hostname, the start and stop times for the session,
> and the duration of the session. If the session is still continuing or was cut
