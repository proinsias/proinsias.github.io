...
The other day I tried to run a `rm` command on the contents of a directory with
a **LOT** of files.
...
Bash wanted to expand the entire command before executing it. It was too long.
