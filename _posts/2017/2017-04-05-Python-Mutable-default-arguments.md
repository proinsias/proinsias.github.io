...
Let's say you want to define a function that accepts a list as a parameter, and
you want the default value of that list to be the empty list, so you write:
...
instead of each time the function is called (like it is in say Ruby). This means
...
Via [thoughtbot/til](https://github.com/thoughtbot/til) and
